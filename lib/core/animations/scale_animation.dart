...
class ScaleAnimation extends StatefulWidget {
  ...
  const ScaleAnimation({super.key, required this.child, this.delay = 0.0, this.duration});

  @override
  ScaleAnimationState createState() => ScaleAnimationState();
}

class ScaleAnimationState extends State<ScaleAnimation> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    controller = AnimationController(vsync: this, duration: widget.duration ?? const Duration(milliseconds: 600));
