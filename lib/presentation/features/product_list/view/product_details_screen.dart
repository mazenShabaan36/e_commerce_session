    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            SizedBox(height: 20), Hero(tag: product.name, child: Image.asset(product.image, width: 200)), //

            SizedBox(height: 20),
            //
            Text(product.name, style: Theme.of(context).textTheme.headlineSmall),
            //
            SizedBox(height: 10), Text('\$${product.price}', style: Theme.of(context).textTheme.titleLarge),
            //
            SizedBox(height: 20),
            //
